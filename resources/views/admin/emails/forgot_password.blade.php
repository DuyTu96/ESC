...
<body>
    ...
    ご不明な点や、お困りのことがございましたらお手数ですが以下の問い合わせフォームよりお問い合わせください。
    <br/><br/>OPNiD 問い合わせ窓口<br>
    <a href="https://{{ config('app.subdomain_admin') }}/inquiry">
        https://{{ config('app.subdomain_admin') }}/inquiry
    </a>
    <br/><br/>OPNiD<br>
