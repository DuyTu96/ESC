<template>
    <div class="l-2col">
        <main class="l-main">
            <div class="l-main__contents-10">
                <div class="center-center m-0">
                    <div class="c-success">
                        <div class="c-success__body">
                            <div class="c-success__txt">
                                <span>本人確認メールを送信しました。</span>
                            </div>
                        </div>
                        <div class="c-success__footer text-left">
                            <span>メールに記載されているリンクにアクセスして頂きメールアドレスを認証してください。</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
export default {
    name: 'AdminRegisterNotification'
};
</script>
